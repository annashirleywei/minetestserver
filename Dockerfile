...
RUN git clone --depth=1 https://github.com/asuna-mt/caverealms \
     /usr/src/minetest/games/asuna/mods &&\
...
RUN git clone --depth=1 https://github.com/asuna-mt/soup \
     /usr/src/minetest/games/asuna/mods &&\
...
RUN git clone --depth=1 https://github.com/asuna-mt/tt \
     /usr/src/minetest/games/asuna/mods &&\
git -C /usr/src/minetest/games/asuna checkout 917bfbb
RUN git clone --depth=1 https://github.com/asuna-mt/tt_base \
     /usr/src/minetest/games/asuna/mods &&\
...
RUN git clone --depth=1 https://github.com/asuna-mt/ADDR \
     /usr/src/minetest/games/asuna/mods &&\
git -C /usr/src/minetest/games/asuna checkout id
RUN git clone --depth=1 https://github.com/asuna-mt/ADDR \
     /usr/src/minetest/games/asuna/mods &&\
git -C /usr/src/minetest/games/asuna checkout id
RUN git clone \
